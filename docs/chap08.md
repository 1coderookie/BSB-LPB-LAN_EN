...
As a rule of thumb you can keep in mind, that all parameters >10000 are virtual parameters. The following list show these parameters (the list may not be complete though):
