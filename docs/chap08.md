...
|  `/A`                   | `Query 24h average values` <br /> `Shows the 24h average values of the parameters, which were defined before within the variable avg_parameters in the file BSB_lan_config.h.`  
