...
[8.2.1 Transmitting the Room Temperature](chap08.md#821-transmitting-the-room-temperature)  
[8.2.2 Simulating the Presence Function](chap08.md#822-simulating-the-presence-function)  
[8.2.3 Executing a Manual DHW-Push](chap08.md#823-executing-a-manual-dhw-push)  
[8.2.4 Retrieving and Controlling via JSON](chap08.md#824-retrieving-and-controlling-via-json)  
[8.2.5 Checking for Not Released Controller Specific Command IDs](chap08.md#825-checking-for-not-released-controller-specific-command-ids)  
...
[9.1 Usage of the Adapter as a Standalone Logger via BSB-LAN](chap09.md#91-usage-of-the-adapter-as-a-standalone-logger-via-bsb-lan)  
...
[12.7.3 WLAN: Nutzung eines zusätzlichen ESP oder eines WLAN-Arduino](kap12.md#1273-wlan-nutzung-eines-zusätzlichen-esp-oder-eines-wlan-arduino)  
